...
class _MyAppState extends State<MyApp> {
  ...
  InterstitialAd createInterstitialAd() {
    return InterstitialAd(
      adUnitId: "ca-app-pub-5776810454825709/1622611859",
      targetingInfo: targetingInfo,
      listener: (MobileAdEvent event) {
  ...
  void initState() {
    super.initState();
    FirebaseAdMob.instance.initialize(appId:"ca-app-pub-5776810454825709~9030344497");
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    RewardedVideoAd.instance.load(
                        adUnitId:"ca-app-pub-5776810454825709/6566684878",
                        targetingInfo: targetingInfo);
                  },
                ),
                RaisedButton(
